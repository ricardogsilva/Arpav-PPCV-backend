...
def generate_configurations(
    ...
    return [
        ...
        CoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="TDd",
            wms_main_layer_name="TDd",
            thredds_url_pattern="cline_yr/TDd_{observation_year_period}_1992-202[34]_py85.nc",
            unit=_UNIT,
            palette="default/seq-YlOrRd",
            color_scale_min=_COLOR_SCALE_MIN,
            color_scale_max=_COLOR_SCALE_MAX,
        ...
        CoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="TDd",
            wms_main_layer_name="TDd",
            thredds_url_pattern="cline_yr/TDd_{observation_year_period}_199[12]-202[34]_py85.nc",
            unit=_UNIT,
            palette="default/seq-YlOrRd",
            color_scale_min=_COLOR_SCALE_MIN,
            color_scale_max=_COLOR_SCALE_MAX,
