        ...
        cov_confs.extend(
            [
                ...
                CoverageConfigurationCreate(
                    ...
                    wms_main_layer_name="TR",
                    thredds_url_pattern=(
                        f"cline_yr/TR_{{observation_year_period}}_{duration}_py85.nc"
                    ),
                    unit=_UNIT,
                    palette="default/seq-YlOrRd",
                    color_scale_min=_COLOR_SCALE_MIN,
