...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "tas_annual_absolute_model_ensemble-annual-model_ensemble-tas-absolute-rcp26-year",
            "tas_annual_absolute_model_ensemble_lower_uncertainty-annual-model_ensemble-tas-absolute-rcp26-lower_bound-year",
            "tas_annual_absolute_model_ensemble_upper_uncertainty-annual-model_ensemble-tas-absolute-rcp26-upper_bound-year",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            "tas_seasonal_anomaly_model_ensemble-annual-model_ensemble-tas-anomaly-rcp26-MAM",
            [
                "tas_seasonal_anomaly_model_ec_earth_cclm4_8_17-annual-ec_earth_cclm_4_8_17-tas-anomaly-rcp26-MAM",
                "tas_seasonal_anomaly_model_ec_earth_racmo22e-annual-ec_earth_racmo22e-tas-anomaly-rcp26-MAM",
                "tas_seasonal_anomaly_model_ec_earth_rca4-annual-ec_earth_rca4-tas-anomaly-rcp26-MAM",
                "tas_seasonal_anomaly_model_hadgem2_es_racmo22e-annual-hadgem2_racmo22e-tas-anomaly-rcp26-MAM",
                "tas_seasonal_anomaly_model_mpi_esm_lr_remo2009-annual-mpi_esm_lr_remo2009-tas-anomaly-rcp26-MAM",
            ],
        )
    ],
)
